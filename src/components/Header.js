    ...
    <>
      <header className='header-top-strip py-3'>
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className='text-white fs-4 mb-0'>Welcome to Technocity</p>
            </div>
            <div className="col-6">
              <p className='text-end text-white mb-0'>
                Hotline:
                <a className='text-white' href="tel:+8801682783475">
                  +8801682783475
                </a>
              </p>
            </div>
      ...
      <header className='header-upper py-3'>
        <div className="container-xxl">
          <div className="row align-items-center">
            ...
            <div className="col-2">
              <h2>
                <Link className='text-white'>Techno City</Link>
              </h2>
            </div>
                ...
                <div>
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <Link
                        className="dropdown-item text-white" to="">
                          Printers
                        </Link>
