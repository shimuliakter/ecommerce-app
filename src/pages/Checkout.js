                    ...
                    <div className="row">
                        ...
                        <div className="col-7">
                            <div className="checkout-left-data">
                                <h3 className='website-name'>Techno City</h3>
                                <nav
                                    ...
                                    <ol className="breadcrumb">
                                        ...
                                        &nbsp; /
                                        <li className="breadcrumb-item total-price active" aria-current="page">payment
                                        </li>
                                    </ol>
                                </nav>
                                <h4 className='title total'>Contact Information</h4>
                                <p className='user-details total'>Ashraful Islam (mdbappy877@gmail.com)</p>

                                <h4 className='mb-3'>Shipping Address</h4>
                                <form action="" className='d-flex gap-15 flex-wrap justify-content-between'>
                                    <div className='w-100'>
                                        <select   defaultValue={'select-country'}  name="" className='form-control form-select' id="">
