              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-10">
                  ...
                  <select defaultValue={'manual'} name="" className='form-control form-select' id="">
                    <option className="option-bg" value="manual">Featured</option>
                ...
                <div className="d-flex align-items-center gap-10">
                  ...
                  <div className='d-flex align-items-center gap-10 grid'>
                    <img onClick={() => {
                      setGrid(3);
                    }} src={grid4} className='d-block img-fluid' alt="grid" />
                    <img onClick={() => {
                      setGrid(4);
                    }} src={grid3} className='d-block img-fluid' alt="grid" />
                    <img onClick={() => {
                      setGrid(6);
                    }} src={grid2} className='d-block img-fluid' alt="grid" />
                    <img onClick={() => {
                      setGrid(12);
                    }} src={grid1} className='d-block img-fluid' alt="grid" />
                  </div>
                </div>
